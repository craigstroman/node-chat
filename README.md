...
###To run locally:
- Open terminal and run git clone https://github.com/craigstroman/node-chat.git.
- Then cd node-chat and run npm install and also bower install.
- To start it then run npm start in the terminal.
